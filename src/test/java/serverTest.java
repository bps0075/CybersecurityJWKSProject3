...
public class serverTest { //This will test the JWKSServer.java file by calling the functions to produce code coverage
    ...
    JWKSServer obj = new JWKSServer();
    @Test
    public void testJWKSServerInitialization() {
        //JWKSServer server = new JWKSServer();
        assertNotNull(server.toString(), "JWKSServer should be initialized"); // Asserts that the JWKSServer instance is not null
    ...
    public void testJWKSHandler() {
        ...
        //JWKSServer server = new JWKSServer();
        //assertNotNull(server.handle()); //Checks if the JWKSHandler server works
        //assertNotNull(jwksHandler.handle(server.jwk)); //Checks if the JWKSHandler server works
